...
namespace SessionPersonality
{
    public class DBDownload
    {
        ...
        public List<int> idRoom = new List<int>();
        public List<int> idHotelRoom = new List<int>();
        public List<string> imgRoom = new List<string>();
        public List<string> statusRoom = new List<string>();
        ...
        public void GetImgRooms()
        {
            
            SqlCommand com = new SqlCommand("SELECT * FROM Rooms", conn);
            rd = com.ExecuteReader();

            while (rd.Read())
            {
                idRoom.Add(Convert.ToInt32(rd.GetValue(0)));
                idHotelRoom.Add(Convert.ToInt32(rd.GetValue(1)));
                imgRoom.Add(rd.GetValue(2).ToString());
                statusRoom.Add(rd.GetValue(3).ToString());
            }
            rd.Close();
        }
    }
